...
# ascii-chess 1967
 ...
 # отличие версии ascii-chess 1969 от предыдущих версий (Актуальная версия на 02.12.2023).
 ...
 7. Добавлен режим бот против бота.
 8. Добавлено чтение/запись FEN позиций (анализатор FEN строки).
 9. Добавлена библиотека шахматных задач: мат в один, два, три и четыре хода. Всего порядка 2500 задач добавлено.
...
# Используемое ПО
движок собран в Visual Studio C++ Comunity 2019 с добавлением OpenMP. Графический интерфейс в Lazarus 2.2.4 free Pascal. Графический интерфейс приложения Шахматная доска собран Delphi RAD Studio 10.4.1 под windows 32bit.
