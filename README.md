...
2. Почему то в Lazarus 2.2.4 приложение не закрывается  после File->Close или после нажатия на красный крестик. А Group Box на форме выбор опонента тупит при нажатии. Закрыть приложение можно сделав последовательно File->Close, нажатие на красный крестик, нажатие свернуть форму и форма закроется. Мне кажется это глюк версии Lazarus 2.2.4 отпишитесь кто знает.
