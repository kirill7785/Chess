...
# Шахматная доска 3D 
(02.07.2024)
![alt_text](https://github.com/kirill7785/Chess/blob/main/pic/Шахматная%20доска%203D%20screen_shot%20%201%2030_06_2024.png)
![alt_text](https://github.com/kirill7785/Chess/blob/main/pic/Шахматная%20доска%203D%20screen%20shot%20%202%2030_06_2024.png)
OpenGL, c++, 3D chess board, проверка шахматных правил. Без движка. Играют двое людей.
![alt_text](https://github.com/kirill7785/Chess/blob/main/pic/unity%203D%20chess%20GUI%207%20июля%202024.bmp)
Набросок к интерфейсу на unity 3D с трассировкой лучей от 7 июля 2024.
...
# ascii-chess 1967
 ...
 4. Надеюсь программа отработае штатно и вы получите удовольствие от использования программы Шахматы e2e4 1.0.3 https://freesoft.ru/windows/e2e4/download/196446 (альтрнативноe названиe ascii-chess 1970).
# Сайт FreeSoft.ru Шахматы e2e4 2.0.1 (Актуальная версия на 3.11.2024).
1. Весь код написан полностью заново на Паскаль Delphi в RAD Studio 11.3. Шахматный движок свой оригинальный написан на Паскале. Сторонние dll не используются.
2. Сделана трёхмерная графика на OpenGL. Трёхмерные фигуры найдены в интернете и загружаются из stl файлов при загрузке программы.
3. Опционально сделано проговаривание всех действий пользователя а также позиций на доске стандартным голосом ОС windows 10 по русски.
4. С компьютером можно играть как за белых, так и за чёрных. Поддерживаются шахматные правила. Ходы не по правилам автоматически отменяются.
5. Надеюсь программа отработае штатно и вы получите удовольствие от использования программы Шахматы e2e4 2.0.1 https://freesoft.ru/windows/e2e4/download/197250
6. В случае нештатного поведения программы можете написать на мою электронную почту kirill7785@mail.ru.  
...
# Используемое ПО
движок собран в Visual Studio C++ Comunity 2022. Также использовался c++ компилятор clang++. Графический интерфейс в Lazarus 3.2. free Pascal 3.2.2. Графический интерфейс приложения Шахматная доска собран Delphi RAD Studio 10.4.1 под windows 32bit. Программа e2e4 2.0.1 собрана на Delphi RAD Studio 11.3 под windows 32bit.
