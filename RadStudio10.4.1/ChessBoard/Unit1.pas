...
// 15.07.2023 Увеличение размеров доски по нажатию стрелочки вверх. Чтобы пользователи не напрягали зрение.
// 22.07.2023 Повернуть шахматную доску.
...
type
  ...
  TForm1 = class(TForm)
    ...
    Undo1: TMenuItem;
    Nextmove1: TMenuItem;
    picturefigures1: TMenuItem;
    setemptyboard1: TMenuItem;
    rotatechessboard1: TMenuItem;
    procedure Save1Click(Sender: TObject);
    procedure Open1Click(Sender: TObject);
    procedure Close1Click(Sender: TObject);
    procedure Undo1Click(Sender: TObject);
    procedure Nextmove1Click(Sender: TObject);
    procedure picturefigures1Click(Sender: TObject);
    procedure rotatechessboard1Click(Sender: TObject);
    ...
    procedure setemptyboard1Click(Sender: TObject);
  private
    { Private declarations }
    m : Real;// масштаб
    b_rotate_chess_board : Boolean; // Повернуть шахматную доску.
...
var
    i,j : Integer;
begin
   if (b_rotate_chess_board) then
     begin

       for i:=1 to 8 do
       for j:=1 to 8 do
       begin
          vacantmove1[9-i][9-j]:=black_attack[i][j];
       end;
...
begin
   ...
   if (b_rotate_chess_board) then
     begin
       ...
       for j:=1 to 8 do
       begin
          vacantmove1[9-i][9-j]:=white_attack[i][j];
       end;
...
begin
  ...
  font.Style:=[fsBold];
     ...
     begin
         for i:=n downto 1 do
        begin
          textout(round(m*20),(9-i)*round(m*60)-round(m*20),inttostr(n-i+1));
          textout((9-i)*round(m*60)+round(m*10),round(m*510),chr(i+96));
        end;
     end
     else
     begin
...
begin
 ...
 cpawn : begin
    ...
    begin
        Pawn(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kr);
    end
    else
    begin
       Pawn(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kw);
    end;
 end;
 crook : begin
    if (odd(arrw[i].i+arrw[i].j)) then
    begin
        Rook(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kr);
    end
    else
    begin
       Rook(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kw);
    end;
 end;
 cknight : begin
    if (odd(arrw[i].i+arrw[i].j)) then
    begin
        Knight(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kr);
    end
    else
    begin
       Knight(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kw);
    end;
 end;
 cbishop : begin
    if (odd(arrw[i].i+arrw[i].j)) then
    begin
        Bishop(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kr);
    end
    else
    begin
       Bishop(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kw);
    end;
 end;
 cqueen : begin
    if (odd(arrw[i].i+arrw[i].j)) then
    begin
        Queen(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kr);
    end
    else
    begin
       Queen(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kw);
    end;
 end;
 cking : begin
    if (odd(arrw[i].i+arrw[i].j)) then
    begin
        King(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kr);
    end
    else
    begin
       King(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),uclr,kw);
    end;
 end;
 end;
end;
...
begin
 ...
 cpawn : begin
    ...
    begin
        Pawn(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kr);
    end
    else
    begin
       Pawn(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kw);
    end;
 end;
 crook : begin
    if (odd(arrb[i].i+arrb[i].j)) then
    begin
        Rook(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kr);
    end
    else
    begin
       Rook(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kw);
    end;
 end;
 cknight : begin
    if (odd(arrb[i].i+arrb[i].j)) then
    begin
        Knight(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kr);
    end
    else
    begin
       Knight(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kw);
    end;
 end;
 cbishop : begin
    if (odd(arrb[i].i+arrb[i].j)) then
    begin
        Bishop(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kr);
    end
    else
    begin
       Bishop(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kw);
    end;
 end;
 cqueen : begin
    if (odd(arrb[i].i+arrb[i].j)) then
    begin
       Queen(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kr);
    end
    else
    begin
       Queen(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kw);
    end;
 end;
 cking : begin
    if (odd(arrb[i].i+arrb[i].j)) then
    begin
        King(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kr);
    end
    else
    begin
       King(round(m*40)+(j1-1)*round(m*60),round(m*20)+(i1-1)*round(m*60),round(m*60),clBlack,kw);
    end;
 end;
 end;
end;
...
{
устарело в связи с поворотом доски.
i:=7;
for j:=1 to n do
begin
   if odd(j) then
...
// Следующий ход.
procedure TForm1.Nextmove1Click(Sender: TObject);
begin
...
procedure TForm1.picturefigures1Click(Sender: TObject);
begin
   if (ipic_fig=1) then
   begin
      ipic_fig:=0;
...
// повернуть шахматную доску.
procedure TForm1.rotatechessboard1Click(Sender: TObject);
begin
    b_rotate_chess_board:=not(b_rotate_chess_board);  // Повернуть шахматную доску.
   Draw(Sender);
   FormPaint(Sender);   
end;
...
begin
   if (Key=VK_LEFT) then
    begin
        ...
        Form1.Undo1Click(Sender);
    end;
    if (Key=VK_RIGHT) then
    begin
        // Перейти на один полуход вперёд
        Form1.Nextmove1Click(Sender);
    end;
    if (Key=VK_UP) then
    begin
...
begin
   if (not(b_rotate_chess_board)) then
    begin
...
procedure TForm1.setemptyboard1Click(Sender: TObject);
var
     i, j : Integer;
begin
   ...
   did_the_white_left_rook_move :=false; // ходили ли белые ладьи
   did_the_black_right_rook_move:=false;
   did_the_black_left_rook_move :=false; // ходили ли черные ладьи
   did_the_white_king_move:=false;
   did_the_black_king_move:=false; // ходили ли короли.
