...
for (int i_7=0; i_7<8; ++i_7) {
	for (int j_7=0; j_7<8; ++j_7) {
	    ...
	    case ChessPiece::W_BISHOP:
         bishop.draw(r0, g0, b0,i_7,j_7,cb[i_7][j_7]);
			break;
			case ChessPiece::B_BISHOP:
         bishop.draw(r1, g1, b1,i_7,j_7,cb[i_7][j_7]);
			break;
			case ChessPiece::W_ROOK:
         castle.draw(r0, g0, b0,i_7,j_7,cb[i_7][j_7]);
			break;
			case ChessPiece::B_ROOK:
         castle.draw(r1, g1, b1,i_7,j_7,cb[i_7][j_7]);
			break;
			case ChessPiece::W_PAWN:
				 pawn.draw(r0, g0, b0,i_7,j_7,cb[i_7][j_7]);
		 break;
		 case ChessPiece::B_PAWN:
				 pawn.draw(r1, g1, b1,i_7,j_7,cb[i_7][j_7]);
		 break;
		 case ChessPiece::W_QUEEN:
				queen.draw(r0, g0, b0,i_7,j_7,cb[i_7][j_7]);
		break;
		case ChessPiece::B_QUEEN:
				queen.draw(r1, g1, b1,i_7,j_7,cb[i_7][j_7]);
		break;
		case ChessPiece::W_KING:
			 king.draw(r0, g0, b0,i_7,j_7,cb[i_7][j_7]);
	 break;
	 case ChessPiece::B_KING:
			 king.draw(r1, g1, b1,i_7,j_7,cb[i_7][j_7]);
	 break;
	 case ChessPiece::W_KNIGHT:
			knightW.draw(r0, g0, b0,i_7,j_7,cb[i_7][j_7]);
	break;
	case ChessPiece::B_KNIGHT:
			knight.draw(r1, g1, b1,i_7,j_7,cb[i_7][j_7]);
	break;
       ...
       int js0=j_select_cell;
        ...
        if (!((is0==i_select_cell)&&(js0==j_select_cell))) {
          ...
          if (bWHITE) {
              ...
              if ((cb[is0][js0]==ChessPiece::W_PAWN)||
                 (cb[is0][js0]==ChessPiece::W_KING)||(cb[is0][js0]==ChessPiece::W_QUEEN)||
                 (cb[is0][js0]==ChessPiece::W_ROOK)||(cb[is0][js0]==ChessPiece::W_BISHOP)||
                 (cb[is0][js0]==ChessPiece::W_KNIGHT)) {

                  // Куда пошли либо пустая клетка либо фигура цвета противника.
                   if ((cb[i_select_cell][j_select_cell]==ChessPiece::B_PAWN)||
                      (cb[i_select_cell][j_select_cell]==ChessPiece::B_KING)||(cb[i_select_cell][j_select_cell]==ChessPiece::B_QUEEN)||
                      (cb[i_select_cell][j_select_cell]==ChessPiece::B_ROOK)||(cb[i_select_cell][j_select_cell]==ChessPiece::B_BISHOP)||
                      (cb[i_select_cell][j_select_cell]==ChessPiece::B_KNIGHT)||(cb[i_select_cell][j_select_cell]==ChessPiece::EMPTY)) {
                        bFigureCheck0=true;
                    }
              }
          ...
          if (!bWHITE) {
              ...
              if ((cb[is0][js0]==ChessPiece::B_PAWN)||
                 (cb[is0][js0]==ChessPiece::B_KING)||(cb[is0][js0]==ChessPiece::B_QUEEN)||
                 (cb[is0][js0]==ChessPiece::B_ROOK)||(cb[is0][js0]==ChessPiece::B_BISHOP)||
                 (cb[is0][js0]==ChessPiece::B_KNIGHT)) {

                   // Куда пошли либо пустая клетка либо фигура цвета противника.
                    if ((cb[i_select_cell][j_select_cell]==ChessPiece::W_PAWN)||
                       (cb[i_select_cell][j_select_cell]==ChessPiece::W_KING)||(cb[i_select_cell][j_select_cell]==ChessPiece::W_QUEEN)||
                       (cb[i_select_cell][j_select_cell]==ChessPiece::W_ROOK)||(cb[i_select_cell][j_select_cell]==ChessPiece::W_BISHOP)||
                       (cb[i_select_cell][j_select_cell]==ChessPiece::W_KNIGHT)||(cb[i_select_cell][j_select_cell]==ChessPiece::EMPTY)) {
                         bFigureCheck0=true;
                     }
